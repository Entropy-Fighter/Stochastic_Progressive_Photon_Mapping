...
{
    Texture *texture_bottom = new Texture("D:/work/InSchool/cg/cg_project_/data/tile.ppm");
    Texture *texture_back = new Texture("D:/work/InSchool/cg/cg_project_/data/back.ppm");
    Texture *texture_top = new Texture("D:/work/InSchool/cg/cg_project_/data/top.ppm");
...
{
    Texture *texture_bottom = new Texture("D:/work/InSchool/cg/cg_project_/data/bottom.ppm");
...
Scene *sceneBox()
{
    ...
    bunny->import_ply("D:/work/InSchool/cg/cg_project_/data/bunny.ply", new TextureMap(Vec3f(0.8, 0.7, 0.6)), STANFORD_MODEL);
    // printf("faq scenebox\n");
    ...
    // bunny->import_ply("D:/work/InSchool/cg/cg_project_/data/dragon_vrip.ply", new TextureMap(Vec3f(0.4, 0.8, 0.8)), STANFORD_MODEL);
    // // printf("faq scenebox\n");
    // bunny->scale(2.8, 0, 0, 0.24,
    //              0, 2.8, 0, -0.09 - 0.5,
    //              0, 0, -2.8, 0.12);
    ...
    water->import_ply("D:/work/InSchool/cg/cg_project_/data/water.ply", new TextureMap(Vec3f(1.0f, 1.0f, 1.0f)), WATER);
    water->scale(
    ...
    // teapot->import_bpt("D:/work/InSchool/cg/cg_project_/data/teapot.bpt", new TextureMap(Vec3f(0.1, 0.8, 0.8)), LIGHT);
    // teapot->scale(
    //     -0.02, 0, 0, 0,
    //     0, 0, 0.02, 0,
    //     0, 0.02, 0, 0);
...
int main(int argc, char *argv[])
{
    ...
    // Camera *camera = new Camera(100, 60);
